...
climatic_data <- read.csv("C:/Users/tfrancisco/Documents/Thèse/Data/Espèces/Taxus_baccata/Climatic_data/corr0.75/climatic_data_indivdual_level_scaled.csv",sep=";",dec=",")
...
#we can use that or ddiretly genomic_data as imput of LFMM2
...
test <- data.frame(read.lfmm("C:/Users/tfrancisco/Documents/Thèse/Data/Espèces/Taxus_baccata/genetic_new/GEA/genomic_data.lfmm"))
```
...
print(latent_factor_LFMM2_outliers_selection)
 ...
 #save
pdf("C:/Users/tfrancisco/Documents/Thèse/Results/species/taxus/GEA/LFMM/latent_factor_LFMM2_outliers_selection.pdf");print(latent_factor_LFMM2_outliers_selection);dev.off()
...
We tested the classic threshold 5% and a more relax one 10% 
...
#FDR correction
outliers_FDR <- data.frame(snp_names=colnames(genomic_data) ,qvalues=qvalue(pv_corrected$pvalues)$qvalues)

#threshold 0.05
thres_FDR <- 0.05

outliers_T_adapcon_gentree_LFMM_5perc <- data.frame(SNP=outliers_FDR$snp_names[which(outliers_FDR$qvalues<thres_FDR)],qvalues = outliers_FDR$qvalues[which(outliers_FDR$qvalues<thres_FDR)])

length(which(outliers_FDR$qvalues < thres_FDR)) ## how many SNPs we have with an FDR < 5%?


#FDR 10% 
thres_FDR <- 0.1

outliers_T_adapcon_gentree_LFMM_10perc <- data.frame(SNP=outliers_FDR$snp_names[which(outliers_FDR$qvalues<thres_FDR)],qvalues = outliers_FDR$qvalues[which(outliers_FDR$qvalues<thres_FDR)])
...
```
We plot in a manhattan plot the outliers with an FDR threshold of 5%
```{r Manhattan plot }
#selection of the outliers from FDR 5%
df_pvalues_calibrated$type <- "Neutral" ;df_pvalues_calibrated$type[df_pvalues_calibrated$SNP%in%outliers_T_adapcon_gentree_LFMM_5perc$SNP] <- "Candidates FDR5%"
...
#plot
 Manhattan_plot_LFMM_FDR_5perc<-ggplot(data = df_pvalues_calibrated) +
...
print(Manhattan_plot_LFMM_FDR_5perc)
 ...
 #save
pdf("C:/Users/tfrancisco/Documents/Thèse/Results/species/taxus/GEA/LFMM/Manhattan_plot_LFMM_FDR_5perc.pdf");print(Manhattan_plot_LFMM_FDR_5perc);dev.off()

```



We also plot in a manhattan plot the outliers with an FDR threshold of 5% and 10%

```{r Manhattan plot }
#selection of the outliers from FDR 5%
df_pvalues_calibrated$type <- "Neutral" 
df_pvalues_calibrated$type[df_pvalues_calibrated$SNP%in%outliers_T_adapcon_gentree_LFMM_10perc$SNP] <- "Candidates FDR10%"
df_pvalues_calibrated$type[df_pvalues_calibrated$SNP%in%outliers_T_adapcon_gentree_LFMM_5perc$SNP] <- "Candidates FDR5%"
df_pvalues_calibrated$type <- as.factor(df_pvalues_calibrated$type)
...
#plot
 Manhattan_plot_LFMM_FDR_5_10perc<-ggplot(data = df_pvalues_calibrated) +
  geom_point(aes(x=1:nrow(df_pvalues_calibrated), y=-log10(pvalues), col = type), size=1.4) +
...
print(Manhattan_plot_LFMM_FDR_5_10perc)
      
 #save
pdf("C:/Users/tfrancisco/Documents/Thèse/Results/species/taxus/GEA/LFMM/Manhattan_plot_LFMM_FDR_5_10perc.pdf");print(Manhattan_plot_LFMM_FDR_5_10perc);dev.off()
...
```{r save outliers set}
#FDR 5%
write_xlsx(outliers_T_adapcon_gentree_LFMM_5perc,"C:/Users/tfrancisco/Documents/Thèse/Results/species/taxus/GEA/outliers/outliers_T_adapcon_gentree_LFMM_5perc.xlsx")
save(outliers_T_adapcon_gentree_LFMM_5perc, file="C:/Users/tfrancisco/Documents/Thèse/Results/species/taxus/GEA/outliers/outliers_T_adapcon_gentree_LFMM_5perc.Rdata")

#FDR 10%
save(outliers_T_adapcon_gentree_LFMM_10perc, file="C:/Users/tfrancisco/Documents/Thèse/Results/species/taxus/GEA/outliers/outliers_T_adapcon_gentree_LFMM_10perc.Rdata")
